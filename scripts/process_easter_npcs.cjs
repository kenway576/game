...
const easterList = [
  {
    src: '1788482535935.jpg',
    target: 'easter_denji.webp',
    name: '电次 (Denji - Chainsaw Man)'
  },
  {
    src: '1788482576416.jpg',
    target: 'easter_reze.webp',
    name: '蕾赛 (Reze - Chainsaw Man)'
  },
  {
    src: '1788482620845.jpg',
    target: 'easter_bocchi.webp',
    name: '后藤一里 (Hitori Gotoh / Bocchi - Bocchi the Rock!)'
  },
  {
    src: '1788482663842.jpg',
    target: 'easter_kita.webp',
    name: '喜多郁代 (Ikuyo Kita - Bocchi the Rock!)'
  },
  {
    src: '1788482702306.jpg',
    target: 'easter_ryo.webp',
    name: '山田凉 (Ryo Yamada - Bocchi the Rock!)'
  },
  {
    src: '1788482744392.jpg',
    target: 'easter_nijika.webp',
    name: '伊地知虹夏 (Nijika Ijichi - Bocchi the Rock!)'
  },
  {
    src: '1788482790677.jpg',
    target: 'easter_yui.webp',
    name: '平泽唯 (Yui Hirasawa - K-ON!)'
  },
  {
    src: '1788482831233.jpg',
    target: 'easter_mio.webp',
    name: '秋山澪 (Mio Akiyama - K-ON!)'
  },
  {
    src: '1788482871556.jpg',
    target: 'easter_rin.webp',
    name: '远坂凛 (Rin Tohsaka - Fate/stay night)'
  }
];
...
async function run() {
  ...
  for (let idx = 0; idx < easterList.length; idx++) {
    const item = easterList[idx];
    console.log(`Processing [${idx + 1}/${easterList.length}] ${item.target} (${item.name}) ...`);
  ...
  .jpeg({ quality: 92 })
  .toFile(path.join(srcDir, '_audit_9_easter_npcs.jpg'));

  console.log('\nAll 9 easter egg character sprites processed, defringed, cropped and saved!');
  console.log('Saved audit sheet: _audit_9_easter_npcs.jpg');
}
