...
export const WARDROBE: Record<string, string[]> = {
  [CharacterId.ASUKA]:  ['casual', 'gym', 'swim', 'maid', 'autumn', 'yukata', 'winter', 'sleep', 'dress', 'kimono'],
...
export const OUTFIT_UNLOCKS: Record<CharacterId, Partial<Record<number, string[]>>> = {
  [CharacterId.ASUKA]:  { 2: ['casual', 'sleep'], 3: ['gym', 'autumn'], 4: ['swim', 'yukata'], 5: ['maid', 'winter', 'dress', 'kimono'] },
